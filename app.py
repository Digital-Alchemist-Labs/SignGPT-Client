...
def display_chat_messages():
    ...
    with chat_container:
        ...
        for msg in st.session_state.chat_messages:
            ...
            if len(current_group) == 4:  # One user message and three system messages
        ...
        for group in conversation_groups:
            ...
            for msg in group:
                ...
                if idx == 0:
                    ...
                    with col3:
                        if st.button("입력 보기", key=f"play_{timestamp}_{user_input}", 
                ...
                if idx == 2:
                    ...
                    if st.button("응답 보기", key=f"play_{timestamp}_{system_input}", 
                                help="Click to see sign language videos for this conversation"):
                        video_output_right.empty()
                        output_text_container.empty()
                        words = system_input
